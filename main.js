...
const urlInput1 = document.getElementById('loadFileURL1');
const urlInput = document.getElementById('loadFileURL1');
...
//           window.location = "https://hyperstep-volumetric.netlify.app";
//           return;
//       }
//   }
// });
...
function loadFile(inputElement) {
  ...
  // see https://github.com/magenta/magenta-js/blob/d8a76682abb0979b985e4b80f6b68b5123b9f8d5/music/src/core/audio_utils.ts
...
void main(void) {
  ...
  int step = 0;
    ...
    // TODO: curve distance estimation
...
function addGUI() {
  ...
  df_folder.add( params, 'global_scale',0, 100).step(0.0001).name( 'global_scale' ).onChange( function ( value ) {
  ...
  spectrogram_folder.add( params, 'mel_spec_bins', 1,512).step(1).name( 'mel_spec_bins' );
